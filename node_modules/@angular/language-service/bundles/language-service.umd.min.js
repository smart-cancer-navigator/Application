...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var Vp=function mt(t){this.full=t,this.major=t.split(".")[0],this.minor=t.split(".")[1],this.patch=t.split(".").slice(2).join(".")},Hp=new Vp("6.1.0"),Bp="ngDebugContext",qp="ngOriginalError",Kp="ngErrorLogger";function Up(t){return t[Bp]}function zp(t){return t[qp]}function Wp(t){for(var e=[],n=1;n<arguments.length;n++)e[n-1]=arguments[n];t.error.apply(t,l(e))}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
