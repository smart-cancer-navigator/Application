...
var routes = [
    ...
    { path: 'disease-selection', component: disease_selection_component_1.DiseaseSelectionComponent },
    { path: 'data-entry/:disease-type', component: data_entry_component_1.DataEntryComponent }
];
