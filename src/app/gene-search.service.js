...
var GeneSearchService = (function () {
    function GeneSearchService(http) {
        this.http = http;
    }
    GeneSearchService.prototype.search = function (term) {
        return this.http
            .get("api/heroes/?name=" + term)
            .map(function (response) { return response.json().data; });
    };
    return GeneSearchService;
}());
GeneSearchService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_1.Http])
], GeneSearchService);
exports.GeneSearchService = GeneSearchService;
//# sourceMappingURL=gene-search.service.js.map