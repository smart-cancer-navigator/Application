  ...
  template: `
    <div id="wrapper">
      ...
      <div class="instructionBlock">
        ...
        <p class="thick">Navigate to <a href="https://sandbox.hspconsortium.org">the HSPC Sandbox</a>, and create a new account.</p>
        <img style="width: 100%" src="/assets/ehr-link/create-account.png">
        <br>
        <p class="thick">Then, you will have to create a new sandbox.  Do so with the FHIR STU3 specification.</p>
        <p class="thick">Following the sandbox creation, navigate to the "Registered Apps" section and click "Register new app manually".  Enter the following parameters: </p>
      ...
      <div class="instructionBlock">
        ...
        <p class="thick">With your new registered app, create a new Practitioner Persona.  Then, create a new launch scenario for the app with any patient and practitioner persona you desire.</p>
      ...
      <div class="instructionBlock">
        ...
        <p class="thick">First, take note of the Client ID for the application.  This long string is required for the application to access the sandbox data.</p>
        <img style="width: 40%" src="/assets/ehr-link/getting-client-id.png">
        <br>
        <p class="thick">Now, click "Launch" on your launch scenario.  Upon beginning the app, you should be prompted for your client ID.  Paste in the one you obtained prior.</p>
